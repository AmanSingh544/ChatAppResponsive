...
export function MessageList({
  ...
  const messageMetaStyle = (isOwn: boolean): React.CSSProperties => ({
    display: "flex",
    alignItems: "center",
    gap: "4px",
    marginTop: "2px",
    fontSize: "11px",
    color: isOwn ? "rgba(255, 255, 255, 0.8)" : colors.mutedText,
              ...
              <div key={groupIndex}>
                ...
                <div style={messageGroupStyle}>
                  {group.messages.map((message, messageIndex) => {
                    ...
                    return (
                      <div key={message.id} style={messageRowStyle(isOwn)}>
                        ...
                        <div style={messageContentStyle(isOwn)}>
                          ...
                          <div style={messageMetaStyle(isOwn)}>
